...
public class CourseActiveListAdapter extends RecyclerView.Adapter<CourseActiveListAdapter.CourseListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseListViewHolder holder, int position) {
        ...
        holder.viewcourses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println("  Couorse model while enrolling :::::     " + listCourseModel.get(holder.getAbsoluteAdapterPosition()).toString());
